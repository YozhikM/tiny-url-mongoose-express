...
// RABOTA.KZ extendings
import type CabinetToken from 'auth/jwt/cabinetToken';
import type AdminToken from 'auth/jwt/adminToken';
import type UserToken from 'auth/jwt/userToken';
import type { HtmlOpts } from 'src/serverRenderHtml';
import type { ClientBootloadActions } from 'clientBootloads';
...
declare class express$Response extends http$ServerResponse mixins express$RequestResponseBase {
  ...
  // RABOTA.KZ extendings
  sendAppHtml(opts: HtmlOpts): void,
  sendAppHtmlBootload(htmlBootload: ClientBootloadActions): void,
}
